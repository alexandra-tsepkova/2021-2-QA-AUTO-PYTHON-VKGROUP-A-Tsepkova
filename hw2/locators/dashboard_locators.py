...
# LOAD_PIC_BUTTON = (By.XPATH, "//div[starts-with(@class, 'roles-module-item')]")
# LOAD_PIC_FIELD_CLASS = (By.XPATH, "//div[starts-with(@class, 'preview-module-preview')]")
LOAD_PIC_FIELD = (By.XPATH, "//input[@type='file']")
# LOADED_PIC = (By.XPATH, "//div[starts-with(@class, 'mediaLibrary-module-imageContainer')]")
# PIC_DROP_FIELD = (By.XPATH, "//div[starts-with(@class, 'upload-module-dropArea')]")
