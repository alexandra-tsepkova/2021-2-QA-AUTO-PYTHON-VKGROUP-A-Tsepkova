...
class APIClient:
    ...
    def load_campaign_url(self, url):
        ...
        url_id = self.session.get("https://target.my.com/api/v1/urls/?url=" + url_parsed).json()['id']
        return url_id
    ...
    def create_campaign(self):
        ...
        resp = self.session.post(create_campaign_url, headers=self.headers, json=campaign_class.data_json)
    ...
    def get_list_of_latest_active_segments(self):
        url_to_check = "https://target.my.com/api/v2/remarketing/segments.json?fields=id"
